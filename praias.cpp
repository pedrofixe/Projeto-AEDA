...
GPS::GPS(unsigned int grau, unsigned int minutos, unsigned int segundos) : grau(grau), minutos(minutos), segundos(segundos){
	if (0 > graus > 90 || 0 > minutos > 60 || 0 > segundos > 60)
		throw CoordenadasErradas(*this);
}

ostream GPS::operator <<(ostream & o, GPS input) {
